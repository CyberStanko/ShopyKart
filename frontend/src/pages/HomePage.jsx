...
const testimonials = [
  {
    ...
    rating: 5,
    text: "ShopyKart has completely transformed my shopping experience. The quality is outstanding and delivery is lightning fast!",
  },
  {
    id: 2,
    name: "Mike Chen",
    ...
    rating: 5,
    text: "I've been shopping here for over a year. The customer service is exceptional and products always exceed expectations.",
  },
  {
    id: 3,
    name: "Emily Davis",
    ...
    rating: 5,
    text: "The user interface is so intuitive and the product selection is amazing. Highly recommend to everyone!",
  },
]
